...
class DomesticTourSetting extends Model
{
    use HasFactory;
    ...
    public function getBaseQuery()
    {
        $query = Tour::query()
            ...
            ->where('status', 'active')
            // Bug fix (2026-07-16): use live whereHas() instead of the cached
            // `next_departure_date` column. See InternationalTourSetting for
    ...
    protected function applyUserFilters($query, array $filters)
    {
        ...
        // Transport filter (airline/bus etc.)
