...
return new class extends Migration
{
    ...
    {
        Schema::create('domestic_tour_settings', function (Blueprint $table) {
            $table->id();
            $table->string('name')->comment('ชื่อ setting เช่น "default", "northern_special"');
            ...
            $table->boolean('show_transport')->default(true)->comment('แสดงสายการบิน/รถ');
    ...
    {
        Schema::dropIfExists('domestic_tour_settings');
    }
};
